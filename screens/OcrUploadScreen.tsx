...
// Ka-Agapay Mobile Resident ID Verification Screen
...
>
<TouchableOpacity onPress={() => router.back()} className="mb-4"> <Text className="text-teal-600 text-3xl leading-none">‹</Text> </TouchableOpacity>
